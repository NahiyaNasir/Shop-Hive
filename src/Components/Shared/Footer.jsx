...
const Footer = () => {
    return (
        <footer className=" mt-24 p-10 font-[sans-serif] tracking-wide bg-gray-700">
                ...
                <div className="lg:flex lg:items-center">
                    <a className="flex flex-col items-center">
                        ...
                        <p className="flex gap-2 text-lg md:text-3xl font-bold text-white">
                         Shop<span className="text-[#bb84e8]">Hive</span>
                        </p>
                    </a>
                </div>
            ...
            <p className="text-gray-300 text-sm mt-10">©Shop Hive. All rights reserved.</p>
        </footer>
    );
};
